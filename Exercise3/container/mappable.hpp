...
public:
  ...
  // Comparison operators
  inline bool operator==(const PreOrderMappableContainer&) const noexcept = delete; // Comparison of abstract types is not possible.
  inline bool operator!=(const PreOrderMappableContainer&) const noexcept = delete; // Comparison of abstract types is not possible.
...
public:
  ...
  // Comparison operators
  inline bool operator==(const PostOrderMappableContainer&) const noexcept = delete; // Comparison of abstract types is not possible
  inline bool operator!=(const PostOrderMappableContainer&) const noexcept = delete; // Comparison of abstract types is not possible.
...
public:
  ...
  // Comparison operators
  inline bool operator==(const InOrderMappableContainer&) const noexcept; // Comparison of abstract types is not possible.
  inline bool operator!=(const InOrderMappableContainer&) const noexcept; // Comparison of abstract types is not possible.
...
public:
  ...
  // Comparison operators
  inline bool operator==(const BreadthMappableContainer&) const noexcept; // Comparison of abstract types is not possible.
  inline bool operator!=(const BreadthMappableContainer&) const noexcept; // Comparison of abstract types is not possible.
